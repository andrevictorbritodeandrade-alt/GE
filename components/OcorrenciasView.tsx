...
export const OcorrenciasView: React.FC<OcorrenciasViewProps> = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16 font-sans">
      {/* Screen Header Padrão Unificado */}
      <div className="print:hidden">
        <ScreenHeader
          onBack={onBack}
          badge="DIÁRIO DISCIPLINAR • 2026"
          statusBadge="REGISTRO OFICIAL"
          title="OCORRÊNCIAS & CONDUTA"
          subtitle="Registro documental de ocorrências disciplinares individuais e coletivas por unidade escolar"
          actions={
            <button
              onClick={handlePrint}
              className="flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-black px-5 py-2.5 rounded-xl shadow-lg transition-all active:scale-95 text-xs uppercase tracking-wider"
            >
