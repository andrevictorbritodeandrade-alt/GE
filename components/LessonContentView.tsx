...
export const LessonContentView: React.FC<LessonContentViewProps> = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16 font-sans">
      <ScreenHeader
        onBack={onBack}
        badge="PLANEJAMENTO PEDAGÓGICO • 2026"
        statusBadge="ATIVO"
        title="CONTEÚDO DAS AULAS"
        subtitle="Roteiro detalhado de atividades práticas, teóricas e didáticas por dia da semana"
      />

      <div className="bg-white/95 backdrop-blur-2xl p-6 md:p-8 rounded-[2.5rem] shadow-2xl border border-slate-200">
