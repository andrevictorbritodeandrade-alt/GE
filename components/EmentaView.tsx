  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20 max-w-5xl mx-auto">
      ...
      <div className="print:hidden">
        <ScreenHeader
          onBack={onBack}
          badge="DIRETRIZES CURRICULARES • 2026"
          statusBadge="SEEDUC-RJ"
          title="EMENTA DA DISCIPLINA"
          subtitle="Fundamentação teórica, objetivos gerais e metodologia da Educação Física Escolar"
          actions={
            <button 
              onClick={handlePrint}
              className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-black uppercase tracking-wider rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 active:scale-95 text-xs"
            >
