...
export const DailyActivityLogView: React.FC<DailyActivityLogProps> = ({ classData, onBack, setClassData, onSave }) => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
      <ScreenHeader
        onBack={onBack}
        badge="DIÁRIO PEDAGÓGICO • 2026"
        statusBadge="REGISTRO DIÁRIO"
        title="REGISTRO DIÁRIO DE AULAS"
        subtitle="Registre os conteúdos ministrados, observações e diário de classe das turmas"
      />

      <div className="p-4 md:p-6 bg-white/90 backdrop-blur-md rounded-3xl border border-slate-200 shadow-xl space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-4">
          <div>
            <h2 className="text-xl md:text-2xl font-black text-slate-800 uppercase tracking-tight">Seleção de Escola e Turma</h2>
            <p className="text-sm text-slate-500">Escolha a unidade escolar e turma para lançar ou visualizar os registros.</p>
          </div>
