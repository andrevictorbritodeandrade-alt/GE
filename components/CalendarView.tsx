...
export const CalendarView: React.FC<CalendarViewProps> = ({ onBack }) => {
  return (
    <div className="space-y-6 animate-fade-in pb-20 max-w-7xl mx-auto">
      ...
      <ScreenHeader
        onBack={onBack}
        badge="RESOLUÇÃO SEEDUC Nº 6392/2025"
        statusBadge="206 DIAS LETIVOS"
        title="CALENDÁRIO ESCOLAR 2026"
        subtitle="Estrutura oficial do Ensino Regular • Matriz de 12 meses por 31 dias"
        rightTitle="GOVERNO DO ESTADO DO RIO DE JANEIRO"
        rightSubtitle="Secretaria de Estado de Educação (SEEDUC-RJ)"
        rightExtra="Ano Letivo de 2026 • 3 Trimestres e Conselhos de Classe"
      />
